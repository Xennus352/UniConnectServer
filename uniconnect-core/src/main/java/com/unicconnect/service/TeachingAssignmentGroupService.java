...
public class TeachingAssignmentGroupService {
    ...
    public TeachingGroupResponse create(CreateTeachingGroupRequest request) {
        ...
        eventPort.publishForTerm(saved.getTerm().getTermId(),
                TimetableEventPort.TEACHING_GROUP_CREATED, payload);
        return response;
    }
    ...
    public void delete(UUID groupId) {
        ...
        eventPort.publishForTerm(termId,
                TimetableEventPort.TEACHING_GROUP_DELETED, payload);
    }
